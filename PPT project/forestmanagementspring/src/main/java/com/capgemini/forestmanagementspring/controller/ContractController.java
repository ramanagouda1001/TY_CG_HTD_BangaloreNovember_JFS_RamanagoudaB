...
import com.capgemini.forestmanagementspring.bean.ContractResponce;
...
public class ContractController {
	...
	public ContractResponce addContract(@RequestBody Contract bean)
	{
		...
		if(status==true) {
			contractResponce.setStatusCode(201);
			contractResponce.setMessage("Contract is Added");
			contractResponce.setDescrption("Client Details Are Added");
		}
		else {
